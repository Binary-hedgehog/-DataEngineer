...
* Чем хорош Spark?
    ...
    * Из коробки дружит с Hadoop, но последний не обязателен для работы со Spark
* Spark состоит из 5 основных компонентов **Spark Core**, **Spark SQL**, **Spark Streaming**, **MLlib**, **GraphX**
* Структура Spark
